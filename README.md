...
|---| ------------- | ------------------- | ----------------------------------- |
| 1 | Частина B. Власна модель рівнів     | нічого | відхилиана пропозиція ChatGPT про використання тегу `<br>` тому, що мною було прийнято рішення не користуватись поміччю нейромережі. |
| 2 |               |                     |                                     |
| 3 |               |                     |                                     |
